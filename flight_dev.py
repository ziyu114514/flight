...
class Flight:
    ...
    # def main():
    #     print('hello world')
    #     data_origin = load_in_data_origin('resources/flight-dataset-2/flights-small.csv',
    #                                       'resources/flight-dataset-2/carriers.csv',
    #                                       'resources/gz_2010_us_040_00_5m.json')
    #     data_dest = load_in_data_dest('resources/flight-dataset-2/flights-small.csv',
    #                                   'resources/flight-dataset-2/carriers.csv',
    #                                   'resources/gz_2010_us_040_00_5m.json')
    #     data_carrier = load_in_data_carrier('resources/flight-dataset-2/flights-small.csv',
    #                                         'resources/flight-dataset-2/carriers.csv')
    #     data_route = load_in_data_route('resources/flight-dataset-2/flights-small.csv',
    #                                     'resources/gz_2010_us_040_00_5m.json')
